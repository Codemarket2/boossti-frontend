...
const Download = ({ className, ...rest }: ViewComponentProps): JSX.Element => {
  ...
  return (
    <div className={clsx(classes.root, className)} {...rest}>
      <SectionHeader
        title={
          <span className={classes.textWhite}>Download the travellers community app now!</span>
        }
        subtitle={
          <span className={classes.textWhite}>
            Don't listen to what they say go and see. Travelling with our app is easy. Join the
            biggest community of travellers.
          </span>
        }
        ctaGroup={[
          <Image
