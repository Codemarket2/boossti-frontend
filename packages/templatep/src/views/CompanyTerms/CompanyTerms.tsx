              ...
              <List className={classes.list}>
                <ListItem disableGutters>
                  ...
                  <Typography variant="body1" color="textPrimary">
                    “Material-UI SAS” is a legal entity located at 128 Rue La Boétie 75008 Paris,
                    France, and is the parent company to all subsidiaries of Material-UI Store.
                  </Typography>
                </ListItem>
                <ListItem disableGutters>
                  <ListItemAvatar>
                ...
                <ListItem disableGutters>
                  ...
                  <Typography variant="body1" color="textPrimary">
                    “CONTENT” means source code, photos, images, vectors, moving images, animations,
                    films, videos, audiovisual works, or other media together with all associated
                    keywords, metadata, and/or titles.
                  </Typography>
                </ListItem>
                <ListItem disableGutters>
                  <ListItemAvatar>
