...
import { DisplayResponse, DisplayResponseProps } from '../DisplayResponse';

const getInitialProps = (): DisplayResponseProps => {
  const props: DisplayResponseProps = {
    form: {
      __typename: 'Form',
...
const DisplyResponseTest = (props: DisplayResponseProps) => {
  return <DisplayResponse {...props} />;
};
