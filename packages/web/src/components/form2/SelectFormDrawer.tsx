...
export default function SelectFormDrawer({ open, parentId, formData, field, onClose }: IProps): any {
                        ...
                        <InputGroup>
                            ...
                            >
                                <Autocomplete
                                    ...
                                    renderTags={(params) => <div>{params[params.length - 1].title}{setFormId(params[params.length - 1].value)}</div>}
                                    renderInput={(params) => <TextField {...params} label="Select Forms" variant="outlined" style={{ width: "50%" }} />}
                                />
