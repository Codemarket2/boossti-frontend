...
import { Icon } from '../../components2/atoms';
import { SectionHeader } from '../../components2/molecules';
import { DescriptionListIcon } from '../../components2/organisms';
      ...
      <Grid container spacing={isMd ? 4 : 2}>
        <Grid item xs={12} sm={6} data-aos={'fade-up'}>
          <DescriptionListIcon
            ...
            icon={
              <Icon fontIconClass="fas fa-book" size="medium" fontIconColor={colors.yellow[700]} />
            }
            align="left"
          />
        </Grid>
