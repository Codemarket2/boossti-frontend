          ...
          <Grid item xs={12} md={6} data-aos="fade-up">
            <Section className={classes.section}>
              <>
                ...
                <SectionHeader
                  title={<span className={classes.textWhite}>A one stop shop for storage.</span>}
                  subtitle={
                    <span className={classes.textWhite}>
                      Forward thinking businesses use our cloud backup service to ensure data
                      reliability and safety. Keep track of what's happening with your data, change
                      permissions, and run reports against your data anywhere in the world.
                    </span>
                  }
                  ctaGroup={[
