...
import { makeStyles, List, ListItem, ListItemAvatar, Typography, Avatar } from '@material-ui/core';
      ...
      <List>
        <ListItem disableGutters>
          ...
          <Typography variant="body1" color="textPrimary">
            More than 45 pages, 300+ component reusable compositions and 30+ stand-alone components
            created by following the Atomic Design Methodology
          </Typography>
        </ListItem>
        <ListItem disableGutters>
          <ListItemAvatar>
          ...
          <Typography variant="body1" color="textPrimary">
            create-react-app & react-scripts support. NextJS & GatsbyJS server side rendering
            support
          </Typography>
        </ListItem>
        <ListItem disableGutters>
        ...
        <ListItem disableGutters>
          ...
          <Typography variant="body1" color="textPrimary">
            Fully responsive on all modern browsers. Figma and Sketch design files (available in
            Standard Plus & Extended licences)
          </Typography>
        </ListItem>
        <ListItem disableGutters>
          <ListItemAvatar>
