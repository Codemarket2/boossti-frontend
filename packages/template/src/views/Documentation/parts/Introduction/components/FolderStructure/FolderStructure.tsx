    ...
    <div className={className} {...rest}>
      ...
      <List>
        <Box display="flex" flexDirection="column">
          <IconText fontIconClass="fas fa-folder" color={colors.blueGrey[900]} title="gatsbyjs" />
          <Typography variant="caption" color="textSecondary">
            The GatsbyJS version of the kit is located in this folder.
          </Typography>
        </Box>
        <Box display="flex" flexDirection="column">
          <IconText fontIconClass="fas fa-folder" color={colors.blueGrey[900]} title="nextjs" />
          <Typography variant="caption" color="textSecondary">
