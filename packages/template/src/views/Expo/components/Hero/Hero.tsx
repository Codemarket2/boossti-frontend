        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6}>
            <Typography variant="h5" className={classes.textWhite} gutterBottom>
              Whether it’s Porsche, Stripe, Intercom, Amazon, or Google, something about TheFront
              works for our global partners.
            </Typography>
            <Typography variant="h5" className={classes.textWhite}>
              Want more information? Download our overview and a member of our specialist team will
              be in touch to talk about your goals for TheFront 2020.
            </Typography>
          </Grid>
          <Grid item xs={12} md={6}>
